...
class LTRProxyTSRAlgorithm(ProxyTSRXGBoostAlgorithm):
...
class AbstainWrapperLTRAlgorithm(AbstainWrapperAlgorithm, LTRProxyTSRAlgorithm):
    """AbstainWrapperAlgorithm backed by LTRProxyTSRAlgorithm, using gap confidence metric."""

    def __init__(self, max_horses: int = 10):
        super().__init__(metric="gap", max_horses=max_horses)
