...
PREDICTORS = [
    ...
    "Going_Firm", "Going_Good", "Going_Good_To_Firm", "Going_Good_To_Soft",
    "Going_Heavy", "Going_Soft",
    ...
    "DaysRested", "LastRaceAvgRelFinishingPosition",
    "LastRaceSurface_AllWeather", "LastRaceSurface_Dirt", "LastRaceSurface_Turf",
    "LastRaceGoing_Good", "LastRaceGoing_Good_To_Soft", "LastRaceGoing_Soft",
    ...
    "JockeyNumberOfPriorRaces", "DaysSinceJockeyLastRaced",
...
def trained_algo() -> RidgeRegressionAlgorithm:
    """Fitted algorithm: 5 races × 3 horses, speeds vary 14–16."""
